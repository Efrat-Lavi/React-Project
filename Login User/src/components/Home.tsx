  ...
  return (
    <Container 
      ...
      <Box 
        ...
        <Typography 
          variant="h5" 
          sx={{ color: '#ffffff', maxWidth: '600px', marginX: 'auto',
        ...
        <Box mt={4} display="flex" justifyContent="center" gap={4}>
          <Button 
            ...
            sx={{ px: 5, py: 1.5, borderRadius: "12px", 
              fontSize: '1.1rem',  backgroundColor: '#FFB74D',color: '#3f51b5',
              '&:hover': {
                backgroundColor: '#FFA726',
              },
            }}
            onClick={()=>navigate('/recipes')}>Go To The Kitchen<RestaurantMenu/>
          </Button>
          <Button 
