import { Typography,Box,Divider,ListItem,ListItemText,Paper,Chip,Avatar, List} from '@mui/material';
import {RestaurantMenu,InfoOutlined,Kitchen } from '@mui/icons-material';
...
const RecipeDetails = ({ recipe }: { recipe: Recipe }) => {
  ...
  return (
    <Paper
      sx={{ p: 3, m: 2, boxShadow: 5, backgroundColor: '#f9f9f9', borderRadius: '16px', }} >
      ...
      <List>
        <ListItem disableGutters>
          ...
          <ListItemText
            primary={ <Typography variant="body1">{recipe.description}</Typography> } />
        </ListItem>
        <Divider sx={{ my: 1 }} />
        <ListItem disableGutters>
